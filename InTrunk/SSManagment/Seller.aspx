							...
							<asp:UpdatePanel ID="uplTree" runat="server" UpdateMode="Conditional">
								<ContentTemplate>
									<asp:TreeView ID="treeCategories" runat="server" ExpandDepth="1" AutoGenerateDataBindings="true"
										...
										OnSelectedNodeChanged="treeCategories_SelectedNodeChanged" Font-Size="8pt">
						...
						<tr>
							<td>
								<asp:GridView ID="gvwProducts" runat="server" AutoGenerateColumns="False" BackColor="White"
									BorderColor="#DEDFDE" BorderStyle="None" CaptionAlign="Top" CellPadding="0" ForeColor="Black"
									GridLines="Vertical" OnRowCommand="gvwProducts_RowCommand" Width="99%" Font-Size="8pt"
									AllowSorting="True" OnRowCreated="gvwProducts_RowCreated" OnSorting="gvwProducts_Sorting"
									PagerStyle-Wrap="False" DataKeyNames="id" OnRowDataBound="gvwProducts_RowDataBound">
									...
									<Columns>
										...
										<asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
											<ItemTemplate>
												<asp:LinkButton ID="lbtnOrder" runat="server" CommandName="order" CausesValidation="false"
										...
										<asp:BoundField DataField="measure" SortExpression="measure" HeaderText="Изм." NullDisplayText="шт"
										...
										<asp:TemplateField HeaderText="В наличии" SortExpression="count" ItemStyle-Wrap="false"
											...
											<ItemTemplate>
												...
												<span id="spanCountCalc" runat="server" visible="false">-
													<asp:Button ID="btnUnReserv" runat="server" Text='<%# Bind("reserveCount") %>' CommandName="unreserv"
														CausesValidation="false" CommandArgument='<%# Eval("id") %>' Height="18px" Font-Size="8pt" />
													= <span id="spanSum" runat="server" style="color: #33CC33; font-size: 9pt; font-weight: bold;
														font-style: normal; font-variant: normal"></span></span>
											</ItemTemplate>
											<HeaderStyle Wrap="False" />
										...
										<asp:TemplateField ShowHeader="False" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
											<ItemTemplate>
												<asp:ImageButton ID="ibtnAdd" runat="server" CausesValidation="false" CommandName="add"
													ToolTip="Добаваить в корзину" ImageUrl="~/App_Themes/Main/Icons/16px-Ambox_emblem_plus.svg.png"
													CommandArgument='<%# Eval("id") %>' />
											</ItemTemplate>
										...
										<asp:TemplateField ShowHeader="False" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
											<ItemTemplate>
												<asp:ImageButton ID="ibtnSale" runat="server" CausesValidation="false" CommandName="sale"
													CommandArgument='<%# Eval("id") %>' ImageUrl="~/App_Themes/Main/Icons/16px-Emblem-advertisement-dollar.svg.png"
													ToolTip="Продать" />
											</ItemTemplate>
											<ControlStyle Height="16px" Width="16px" />
										</asp:TemplateField>
										<asp:TemplateField ShowHeader="False" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
											<ItemTemplate>
												<asp:ImageButton ID="ibtnReserv" runat="server" CausesValidation="false" CommandName="reserved"
													CommandArgument='<%# Eval("id") %>' ImageUrl="~/App_Themes/Main/Icons/16px-Emblem-symbolic-link.svg.png"
						...
						<div class="Widget_Body_container">
							...
							<div class="Widget_Body_content">
								...
								<table cellpadding="0" cellspacing="0" width="100%" style="margin-left: -3px">
											...
											<asp:GridView ID="gvwShoppingCart" runat="server" Width="100%" AutoGenerateColumns="False"
												...
												<Columns>
													...
													<asp:TemplateField HeaderText="Кол-во">
														<ItemTemplate>
															<asp:TextBox ID="txtBuyCount" OnTextChanged="txtBuyCount_TextChanged" runat="server"
																Text='<%# Eval("BuyCount") %>' Width="20px" AutoPostBack="True"></asp:TextBox>
														</ItemTemplate>
									...
									<tr>
										<td>
											&nbsp; <span id="spanShopingCartSum" runat="server" visible="false">Итого :&nbsp;</span><asp:Label
												ID="lblSum" runat="server"></asp:Label>
										</td>
									</tr>
									<tr>
										<td>
										...
										<table cellpadding="0" cellspacing="0">
											<tr>
												<td align="center" colspan="2">
													<asp:GridView ID="gvwShpingCartConfirm" runat="server" Width="100%" AutoGenerateColumns="False"
														BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" CellPadding="2" ForeColor="Black"
														GridLines="Vertical" Font-Size="9pt">
														<RowStyle BackColor="#F7F7DE" />
														<Columns>
											...
											<tr>
												...
												<td>
													<span id="spanShopConfirm" runat="server">Итого :&nbsp;</span><asp:Label ID="lblShopConfirmSum"
														runat="server" Font-Size="12pt"></asp:Label>
												</td>
											</tr>
											<tr>
												<td colspan="2">
								...
								<div class="Widget_Body_content">
									...
									<center>
										<table cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td align="center" colspan="2">
													<asp:GridView ID="gvwSingleBuy" runat="server" Width="100%" AutoGenerateColumns="False"
														BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" CellPadding="2" ForeColor="Black"
														GridLines="Vertical" Font-Size="9pt">
														<RowStyle BackColor="#F7F7DE" />
														<Columns>
															...
															<asp:TemplateField HeaderText="Кол-во">
																<ItemTemplate>
																	<asp:TextBox ID="txtSingleBuyCount" OnTextChanged="txtSingleBuyCount_TextChanged"
																		runat="server" Text='<%# Eval("BuyCount") %>' Width="20px" AutoPostBack="True"></asp:TextBox>
																</ItemTemplate>
																<ControlStyle Width="27px" />
															</asp:TemplateField>
														</Columns>
											...
											<tr>
												...
												<td>
													<span id="spanSingleBuySum" runat="server">Итого :&nbsp;</span><asp:Label ID="lblSingleBuySum"
														runat="server" Font-Size="12pt"></asp:Label>
												</td>
											</tr>
											<tr>
					...
					<center>
						<div>
							<div class="Widget_heading_container">
								...
								<center>
									<h2>
										Вернуть в продажу зарезервироанный товар?
									</h2>
								</center>
							</div>
							<div class="Widget_Body_container">
								...
								<div class="Widget_Body_content">
									...
									<center>
										<table width="100%">
											...
											<tr>
												<td>
													Попробуйте позже и известите администратора об этом сообщении, атакже укажите ситуацию
													при которой это сообщение появляется.
												</td>
											</tr>
											<tr>
												<td>
								...
								<div class="Widget_Body_content">
									...
									<center>
										<table width="100%">
											<tr>
												<td align="center" colspan="2">
													<span>Название товара :&nbsp;</span><asp:TextBox ID="txtDemandProduct" runat="server"
											...
											<tr>
												<td align="center">
													<table cellpadding="0" cellspacing="0" width="100%">
														...
														<tr>
															<td colspan="2" align="center">
																<asp:GridView ID="gvwReturn" runat="server" Width="100%" AutoGenerateColumns="False"
																	BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" CellPadding="2" ForeColor="Black"
																	GridLines="Vertical" Font-Size="9pt" OnRowCommand="gvwReturn_RowCommand" OnRowDeleting="gvwReturn_RowDeleting">
																	<RowStyle BackColor="#F7F7DE" />
																	<Columns>
																		<asp:BoundField HeaderText="Товар" DataField="name">
																			<ControlStyle Width="100%" />
																		...
																		<asp:TemplateField ShowHeader="False">
																			<ItemTemplate>
																				<asp:ImageButton ID="btnDelete" runat="server" CausesValidation="false" CommandName="return"
																					CommandArgument='<%# Eval("id") %>' ImageUrl="~/App_Themes/Main/Icons/Source/48px-Ambox_emblem_arrow.svg.png"
																					ToolTip="Вернуть" />
																			</ItemTemplate>
																			<ControlStyle Height="24px" Width="24px" />
																		</asp:TemplateField>
					...
					<center>
						<div>
							<div class="Widget_heading_container">
								...
								<center>
									<h2>
										Подать заявку на закупку товара?
									</h2>
								</center>
							</div>
							<div class="Widget_Body_container">
