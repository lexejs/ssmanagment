...
<asp:Content ID="cntCategories" ContentPlaceHolderID="cphStandartCategories" runat="server">
	<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td>
				<div class="Widget_heading_container"><span></span>
					<h2>
						Разделы</h2>
				</div>
				<div class="Widget_Body_container">
					...
					<div class="Widget_Body_content">
						<div class="clear"></div>
						<asp:TreeView ID="treeCategories" runat="server" ExpandDepth="1" AutoGenerateDataBindings="true" ForeColor="#333333" ShowLines="True" Height="100%" Width="100%" BackColor="#F7F7DE" BorderColor="#DEDFDE" BorderWidth="1px">
					...
					<td align="center">
						<asp:GridView ID="gvwShoppingCart" runat="server" Width="100%" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical">
							...
							<Columns>
								...
								<asp:ButtonField ButtonType="Image" CommandName="delete" ImageUrl="~/App_Themes/Main/Icons/120px-Dialog-error.svg.png" Text="Удалить">
									<ControlStyle Height="24px" Width="24px" />
								</asp:ButtonField>
							</Columns>
							<FooterStyle BackColor="#CCCC99" />
