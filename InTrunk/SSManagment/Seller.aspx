							...
							<td>
								<asp:GridView ID="gvwProducts" runat="server" AutoGenerateColumns="False" BackColor="White"
									...
									<Columns>
										...
										<asp:BoundField DataField="bprice" SortExpression="bprice" HeaderText="Цена" NullDisplayText="уточнить"
													...
													<tr>
														<td align="left">
															<asp:LinkButton ID="lbtnOrder" runat="server" CommandName="order" CausesValidation="false"
																CommandArgument='<%# Eval("id") %>'>Заказать</asp:LinkButton>
														</td>
													</tr>
													<tr>
								...
								<div class="Widget_Body_content">
									...
									<center>
										<table width="100%">
											...
											<tr><td>Попробуйте позже и известите администратора об этом сообщении, атакже укажите ситуацию при которой это сообщение появляется.</td>
											</tr>
											<tr>
												<td>
												<br />
