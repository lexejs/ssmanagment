                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <table>
                                                                <tr>
                                                                    <td colspan="2">
                                                                        <asp:TextBox ID="txtGroupName" runat="server" Width="180px" TabIndex="1"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="2">
                                                                        <asp:DropDownList ID="ddlAttachTo" runat="server" Width="150px">
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <td valign="top">
                                                            <table>
                                                                <tr>
                                                                    <td colspan="2">
                                                                        <asp:TextBox ID="txtSubGroupName" runat="server" Width="180px" TabIndex="44"></asp:TextBox>
                                                                    </td>
                                                                    <td>
