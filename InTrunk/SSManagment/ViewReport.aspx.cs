...
namespace SSManagment
{
    public partial class ViewReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            source = new ReportDataSource("REOAuctionResultsStruct", list);
            //reportViewer1.LocalReport.DataSources.Add(source);
            //reportViewer1.LocalReport.ReportEmbeddedResource = "ReportsApplication.Reports.REOAuctionResults.REOAuctionResults.rdlc";
        }
